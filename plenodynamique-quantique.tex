...
\begin{document}
	...
	\begin{center}
		\begin{minipage}{0.9\textwidth}
			\begin{tcolorbox}[colback=pkcolor!13, arc=3pt, boxrule=0pt, left=6pt,
				...
				retrouvant le déterminisme perdu en mécanique quantique. De fait, la plénodymanique quantique  est une candidate
	...
	\end{center}
	\begin{center}
			An English translation is proposed at the end of the French version (on page \pageref{English}).
	\end{center}
