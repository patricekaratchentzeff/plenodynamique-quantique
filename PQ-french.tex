...
capitale de modéliser cette structure.
...
possède une masse ($w > w_c$), alors l'exergie de l'onde --~que l'on
...
possibles. Avec une chiralité de 7, \textit{la charge varie par groupe de 6
paires.}
...
rotations rend la visualisation du champ résultat extrêmement
